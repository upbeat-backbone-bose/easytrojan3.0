...
case $(uname -m) in
    x86_64)
        caddy_url=https://github.com/upbeat-backbone-bose/easytrojan3.0/releases/download/2.10.2/caddy_amd64
        ;;
    aarch64)
        caddy_url=https://github.com/upbeat-backbone-bose/easytrojan3.0/releases/download/2.10.2/caddy_arm64
        ;;
    *) 
